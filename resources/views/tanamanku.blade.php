...
<div class="bg-[#f4f1e8] text-gray-800">
  ...
  <!-- Hero Section -->
  <div class="bg-white mt-6 px-6 md:px-12">
    <div class="flex flex-col md:flex-col justify-between overflow-hidden">
      <div class="flex flex-row w-full bg-[#F2EED7] mt-10 rounded-2xl shadow-md">
      ...
      <section class="px-6 py-10">
        <div class="flex flex-row justify-between items-center mb-8">
          <h2 class="text-4xl font-bold text-[#798645] ">Tanamanku</h2>
          <div>
            ...
            <div class="flex flex-col gap-4 text-sm text-[#333] w-full md:w-auto">
              <div class="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p>{{ $t->intensitas_cahaya ? $t->intensitas_cahaya . ' lux' : 'Tidak diketahui' }}</p>
                </div>
              </div>
              <div class="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p>{{ $t->kebutuhan_air ? $t->kebutuhan_air . ' ml' : '-' }}</p>
                </div>
              </div>
              <div class="flex items-center gap-6">
              ...
              <a href="{{ route('tanaman.edit', $t->id_tanaman) }}" class="bg-[#798645] text-white py-2 px-24 rounded-full mt-2 inline-block">Atur</a>
            </div>
          </div>
          @endforeach
        </div>
